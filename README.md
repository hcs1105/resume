# 이력서 ![GitHub Last ommit](https://img.shields.io/github/last-commit/hcs1105/RESUME.svg)
...
- 애드토핑 퍼블리싱팀 주임(2009.12~2010.03)
- 시큐에버 R&D 사업부 사원(2009.06~2009.09)
...
2. 고객사 : 노무법인 씨앤비
3. 개발 언어 / 버전 관리 도구 : HTML, CSS, JavaScript, Angularjs / Git
4. 담당 업무 : 프론트앤드 개발
...
1. 참여 기간 : 2010.10 ~ 2015.05
2. 고객사 : 세창인스트루먼트(현재는 Wepware사로 분리하여 서비스 제공)
3. 개발 언어 / 버전 관리 도구 : HTML, LESS, JavaScript / SVN
4. 담당 업무 : UI 개발
5. 소개 : 웹웨어는 공급된 다양한 콘텐츠뿐만 아니라 사용자가 원하는 콘텐츠를 스스로 저장해 언제 어디서나 활용하고 공유할 수 있는 사용자 중심의 서비스 웹 클라우드 플랫폼입니다.

#### 웹웨어[국문] - http<span>://</span>www.wepware.kr(2010년 10월에 사이트 페쇄)
1. 참여 기간 : 2010.04 ~ 2010.09
2. 고객사 : 세창인스트루먼트(현재는 Wepware사로 분리하여 서비스 제공)
3. 개발 언어 / 버전 관리 도구 : HTML, LESS, JavaScript / SVN
4. 담당 업무 : UI 개발
5. 소개 : 글로벌화 버전으로 목표가 변경되어서 2010년 10월에 웹웨어[영문]으로 도메인이 통합되었습니다.
...
#### 세창인스트루먼트 홈페이지 - http://corp.sechang.com
1. 참여 기간 : 2015.01 ~ 2015.03
2. 고객사 : 세창인스트루먼트
3. 개발 언어 / 버전 관리 도구 : HTML, CSS, jQuery / SVN
4. 담당 업무 : UI 개발
5. 소개 : 세창인스트루먼트의 비전과 사명을 세상에 공유하기 위해 만들어진 반응형 웹 사이트입니다.
...
#### [코레일유통 - 케이스트리] - http<span>://</span>www.k-story.or.kr(2015년 6월 15일부로 사이트 폐쇄)
1. 참여 기간 : 2009.12.01 ~ 2010.03.08
2. 고객사 : 코레일유통
3. 개발 언어 : HTML, CSS, jQuery
4. 담당 업무 : UI 개발
5. 소개 : 대구 지역의 관광 안내를 제공하기 위해 구축한 관광 안내 포털 사이트입니다.

### 시큐에버

#### [KISA] - 정보보호 예보 체계 시스템 구축
1. 참여 기간 : 2009.06.15 ~ 2009.09.11
2. 고객사 : KISA
3. 개발 언어 : HTML, CSS, JavaScript
4. 담당 업무 : UI 개발
5. 소개 : 2009년에 만연했던 디도스(DDos)의 예방과 현황 파악을 위해 KISA와 함께 개발한 솔루션입니다.